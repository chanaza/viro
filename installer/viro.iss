...
Source: "..\agent_service\*";   DestDir: "{app}\agent_service"; Flags: ignoreversion recursesubdirs; Excludes: "__pycache__,*.pyc"
Source: "..\core\*";            DestDir: "{app}\core";          Flags: ignoreversion recursesubdirs; Excludes: "__pycache__,*.pyc"
